...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    void initEvents() {
        ...
        actsEventses.add(new ActsEvents("Paul Preaches to the Jews in Pisidia", "Pisidian Antioch", 38.348633, 31.176502, true));
        actsEventses.add(new ActsEvents("Paul Preaches to the Jews and Gentiles in Iconium", "Iconium", 37.883530, 32.494262, true));
        actsEventses.add(new ActsEvents("Paul Heals a Lame Man", "Lystra", 37.578134, 32.453182, true));
        actsEventses.add(new ActsEvents("Paul and Silas Are Arrested", "Phillip", 41.011959, 24.286190, true));
        actsEventses.add(new ActsEvents("Paul Strengthens the Thessalonian Church", "Thessalonia", 40.632155, 22.932086, true));
        actsEventses.add(new ActsEvents("Paul Strengthens the Berean Church", "Berea", 40.516700, 22.200000, true));
        actsEventses.add(new ActsEvents("Paul Strengthens the Athenian Church", "Athens", 37.983333, 23.733333, true));
        actsEventses.add(new ActsEvents("Paul Strengthens the Corinthian Church", "Corinth", 37.905957, 22.877881, true));
        actsEventses.add(new ActsEvents("Paul Strengthens the Ephesian Church", "Ephesus", 37.953314, 27.367825, true));
        actsEventses.add(new ActsEvents("Paul Strengthens the Galatian Church", "Galatia", 37.578134, 32.453182, true));
        actsEventses.add(new ActsEvents("Paul Returns to Jerusalem for the Pentecost", "Jerusalem", 31.732204, 35.207756, true));
